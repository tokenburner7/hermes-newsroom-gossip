"""BuzzFeed Celebrity (RSS) ingestion source.

Reads BuzzFeed's celebrity RSS feed and upserts recent posts. We fetch the bytes
...
SOURCE_CLASS = "buzzfeed"

log = logging.getLogger(__name__)

FEED_URL = "https://www.buzzfeed.com/celebrity.xml"
