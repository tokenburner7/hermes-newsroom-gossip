"""Just Jared (celebrity gossip RSS) ingestion source.

Reads Just Jared's public RSS feed and upserts recent posts. We fetch the bytes
...
SOURCE_CLASS = "justjared"

log = logging.getLogger(__name__)

FEED_URL = "https://www.justjared.com/feed/"
