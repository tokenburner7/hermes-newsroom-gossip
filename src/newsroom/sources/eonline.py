"""E! Online (entertainment news RSS) ingestion source.

Reads E! Online's public RSS feed and upserts recent posts. We fetch the bytes
...
SOURCE_CLASS = "eonline"

log = logging.getLogger(__name__)

FEED_URL = "https://eol-feeds.eonline.com/rssfeed/us/top_stories"
